...
class RetryClientTests(ZookeeperTestCase):
    ...
    def xtest_wb_connect_after_timeout(self):
        """
    ...
    def xtest_wb_reconnect_after_timeout_and_close(self):
        """
    ...
    def xtest_get_with_watcher(self):
        """
    ...
    def xtest_get_with_watcher_and_delete(self):
        """
        The client can specify a callable watcher when invoking get. The
        watcher will be called back when the client path is modified in
        another session.
    ...
    def xtest_exist_watch_with_node_change(self):
        """
    ...
    def xtest_exists_with_watcher_and_close(self):
        """
    ...
    def xtest_exists_with_nonexistant_watcher(self):
        """
    ...
    def xtest_get_children_with_watch_container_deleted(self):
        """
    ...
    xtest_get_children_with_watch_container_deleted.timeout = 5
